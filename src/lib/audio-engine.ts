...
export class AudioEngine {
  ...
  private static readonly MOVEMENT_CUE_MIN_INTERVAL_MS = 100; // Minimum ms between cues — must be shorter than detector debounce (100ms) so audio never gates a legitimate trigger
