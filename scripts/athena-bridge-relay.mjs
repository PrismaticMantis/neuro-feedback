#!/usr/bin/env node
/**
 * Temporary WebSocket relay for Athena iOS → NeuroSymphony dev page.
...
wss.on('listening', () => {
  ...
  console.log(`[athena-bridge] NeuroSymphony: open /athena-bridge-dev.html and connect to ws://localhost:${PORT}`);
